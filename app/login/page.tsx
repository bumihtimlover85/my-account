...
import { LayoutGrid, Mail, Lock, LogIn, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="rounded-[calc(20px-1.5px)] bg-surface dark:bg-surface-elevated shadow-elevated">
            <div className="p-8 sm:p-10">
              ...
              <div className="flex flex-col items-center mb-8">
                ...
                <h1 className="text-xl font-semibold text-text-primary">欢迎回来</h1>
                <p className="text-sm text-text-tertiary mt-1">登录你的账号继续使用</p>
              </div>
